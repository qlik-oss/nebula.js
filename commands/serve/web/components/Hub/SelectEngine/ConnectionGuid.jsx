...
const ConnectionGuid = ({ showInstructions }) => {
  return (
    <Collapse in={showInstructions}>
      ...
      <Typography variant="body2" paragraph>
        ...
        format that differs slightly between products. Enter the WebSocket URL that corresponds to the Qlik product you
        are using.
      </Typography>
      ...
      <Typography variant="body2" paragraph>
        ...
        <br />
        <br />
        Note that for the Qlik Sense Proxy to allow sessions from this webpage, <code>{window.location.host}</code>{' '}
