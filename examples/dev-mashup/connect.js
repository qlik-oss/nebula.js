    ...
    app
      .setScript(
        ...
        Load
         ...
         Pick(Ceil(3*Rand1),'Another word Another word','Behind the class','Cover the labels') as Dim1,
         Pick(Ceil(6*Rand1),'another A','the class the class','cover the classes','defer the requests','eller inte','asdasdsad asdasd asd asdasd') as Dim2,
